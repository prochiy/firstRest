...
public class PriorityThreadPoolExecutor extends ThreadPoolExecutor implements PriorityExecutorService
{
    ...
    {
        this(corePoolSize, maximumPoolSize, keepAliveTime, unit, java.util.concurrent.Executors.defaultThreadFactory(), defaultHandler);
    }
    ...
    {
        this(corePoolSize, maximumPoolSize, keepAliveTime, unit, java.util.concurrent.Executors.defaultThreadFactory(), handler);
    }
